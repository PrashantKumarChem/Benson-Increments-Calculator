...
- [ ] Move constants (e.g., conversion factors) to the top of the code with comments explaining their source.
...
## 10. Documentation
- [ ] Add a section at the top of the notebook or a markdown cell explaining how to use the tool.
- [ ] Document the expected input file format and output meaning.
